...
| EfficientNetB5  | SE + CA + DINOv2 Head                | Channel-Wise Attention + Global Self-Attention |
| EfficientNetB5  | SE + CA + Swin Transformer Head      | Channel-Wise Attention + Hierarchical Local Attention |
